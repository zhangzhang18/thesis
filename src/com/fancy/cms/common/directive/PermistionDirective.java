package com.fancy.cms.common.directive;
...
import com.fancy.cms.util.DirectiveUtil;
...
public class PermistionDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		String url = DirectiveUtil.getString(PermistionDirective.PARAM_URL, params);
		boolean pass = false;
	...
	private TemplateSequenceModel getPerms(Environment env) throws TemplateModelException {
		TemplateModel model = env.getDataModel().get(com.fancy.cms.util.Constants.PERMISSION_MODEL);
		if (model == null) {
			return null;
		}
